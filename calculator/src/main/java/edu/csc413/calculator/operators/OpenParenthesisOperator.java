...
public class OpenParenthesisOperator extends Operator{
    ...
    //this method is not filled out correctly so it just adds things when "execute is called"
    {
